...
As discussed in out last Class, this code will attempt to showcases the concepts of OOP as implemented in Python,
...
class DicountedCart(ShoppingCart):
    ...
    def cart_contents(self):
        ...
        print("Cart Contents: ")
        for name, qty, price in self.items:
            print(f"  {name}:- {qty} @ Ksh {(price*(1-self.discount_rate)):.2f} each")
        print(f"Total: Ksh {self.calculate_total():.2f}\n")
...
class TaxedCart(ShoppingCart):
    ...
    def cart_contents(self):
        ...
        print("Cart Contents: ")
        for name, qty, price in self.items:
            print(f"  {name}:- {qty} @ Ksh {(price*(1+self.tax_rate)):.2f} each")
        print(f"\nTotal: Ksh {self.calculate_total():.2f}\n")
